...
$title = "Please Login to access the website";
$mode = $_REQUEST["mode"];
if ($mode == "login") {
                    ...
                    <div class="form-group">
                        <div class="col-lg-6 col-lg-offset-2">
                            <div class="help-block">
                                <strong>Testing Role Login Details</strong><br> ADMIN = Username: carlwilding || Password: 123456<br> VALVE ADMIN = Username: zlatan || Password: ibrahimovic<br> VALVE TESTER = Username: romelu || Password: lukaku<br> GUEST ACCOUNT = Username: guest || Password: guest<br>
